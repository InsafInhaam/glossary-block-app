    ...
    <>
      <div className="header">
        <div className="container">
          ...
          <p className="glossary-p">
            Type in a keyword or click on a letter to search
          </p>
          <input
            type="text"
            placeholder="Search..."
